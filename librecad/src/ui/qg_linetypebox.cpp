...
void QG_LineTypeBox::init(bool showByLayer, bool showUnchanged)
{
    ...
    if (showByLayer)
    {
        addItem(QIcon(":ui/linetype00.png"), tr("ByLayer"), RS2::LineByLayer);
        addItem(QIcon(":ui/linetype00.png"), tr("ByBlock"), RS2::LineByBlock);
    }
...
/**
    Sets the pixmap showing the linetype of the "ByLayer" item.
