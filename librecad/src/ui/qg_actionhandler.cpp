...
RS_ActionInterface *QG_ActionHandler::setCurrentAction(RS2::ActionType id)
{
    ...
    switch (id)
    {
        ...
        case RS2::ActionModifyCopy:
            if(!document->countSelected())
            {
                a = new RS_ActionSelect(this, *document, *view, RS2::ActionModifyCopyNoSelect);
                break;
            }
        case RS2::ActionModifyCopyNoSelect:
            a = new RS_ActionModifyCopy(*document, *view);
            break;
...
void QG_ActionHandler::slotModifyCopy()
{
    setCurrentAction(RS2::ActionModifyCopy);
}
