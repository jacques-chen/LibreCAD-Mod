...
RS_Commands::RS_Commands()
{
    std::initializer_list<LC_CommandItem> commandList =
    {
        ...
        //dimension aligned
        {
            ...
            {{"dal", QObject::tr("dal", "dimension - aligned")}},
            RS2::ActionDimAligned
        },
        //dimension linear
        {
            {{"dimlinear", QObject::tr("dimlinear", "dimension - linear")}},
            {   {"dli", QObject::tr("dli", "dimension - linear")},
        ...
        //copy
        {
            ...
            {{"co", QObject::tr("co", "modify - copy")}},
            RS2::ActionModifyCopy
        },
        //move
        {
            {{"move", QObject::tr("move", "modify - move")}},
            {   {"mv", QObject::tr("mv", "modify - move")},
        ...
        //explode
        {
            ...
            {   {"xp", QObject::tr("xp", "explode block/polyline into entities")},
                {"x", QObject::tr("x", "explode block/polyline into entities")}
            },
