...
struct RS_ActionModifyCopy::Points
{
    RS_CopyData data;
...
RS_ActionModifyCopy::RS_ActionModifyCopy(RS_EntityContainer &container,
        RS_GraphicView &graphicView)
    : RS_PreviewActionInterface("Copy Entities",
                                container, graphicView)
    , pPoints(new Points{})
{
    actionType = RS2::ActionModifyCopy;
}

RS_ActionModifyCopy::~RS_ActionModifyCopy() = default;

void RS_ActionModifyCopy::trigger()
{

    RS_DEBUG->print("RS_ActionModifyCopy::trigger()");

    RS_Modification m(*container, graphicView);
    m.copyTo(pPoints->data);
...
void RS_ActionModifyCopy::mouseMoveEvent(QMouseEvent *e)
{
    RS_DEBUG->print("RS_ActionModifyCopy::mouseCopyEvent begin");
    ...
    RS_DEBUG->print("RS_ActionModifyCopy::mouseMoveEvent end");
}


void RS_ActionModifyCopy::mouseReleaseEvent(QMouseEvent *e)
{
...
void RS_ActionModifyCopy::coordinateEvent(RS_CoordinateEvent *e)
{
...
void RS_ActionModifyCopy::updateMouseButtonHints()
{
    switch (getStatus())
    {
        /*  case Select:
        		RS_DIALOGFACTORY->updateMouseWidget(tr("Pick entities to Copy"),
        									   tr("Cancel"));
        		break;*/
        case SetReferencePoint:
...
void RS_ActionModifyCopy::updateMouseCursor()
{
    if(graphicView != NULL)
    {
