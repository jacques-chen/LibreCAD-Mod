...
class RS_OverlayBox : public RS_AtomicEntity
{
    public:
        ...
        RS_Vector getNearestEndpoint(const RS_Vector &, double *)const override
        {
            return {};
        }
        RS_Vector getNearestPointOnEntity(const RS_Vector &, bool, double *, RS_Entity **)const override
        {
            return {};
        }
        RS_Vector getNearestCenter(const RS_Vector &, double *)const override
        {
            return {};
        }
        RS_Vector getNearestMiddle(const RS_Vector &, double *, int)const override
        {
            return {};
        }
        RS_Vector getNearestDist(double, const RS_Vector &, double *)const override
        {
            return {};
        }
        double getDistanceToPoint(const RS_Vector &, RS_Entity **, RS2::ResolveLevel, double)const override
        {
            return -1;   //is -1 right here
        }
