...
class RS_DialogFactoryAdapter : public RS_DialogFactoryInterface
{
    public:
        ...
        RS_GraphicView *requestNewDocument(const QString &, RS_Document *)
        {
            return nullptr;
        }
        RS_Layer *requestNewLayerDialog(RS_LayerList *) override
        {
            return nullptr;
        }
        RS_Layer *requestLayerRemovalDialog(RS_LayerList *) override
        {
            return nullptr;
        }
        QStringList requestSelectedLayersRemovalDialog(RS_LayerList *) override
        {
            return {};
        }
        RS_Layer *requestEditLayerDialog(RS_LayerList *) override
        {
            return nullptr;
        }
        RS_BlockData requestNewBlockDialog(RS_BlockList *) override
        {
            return {};
        }
        RS_Block *requestBlockRemovalDialog(RS_BlockList *) override
        {
            return nullptr;
        }
        QList<RS_Block *> requestSelectedBlocksRemovalDialog(RS_BlockList *) override
        {
            return {};
        }
        RS_BlockData requestBlockAttributesDialog(RS_BlockList *) override
        {
            return {};
        }
        ...
        bool requestAttributesDialog(RS_AttributesData &, RS_LayerList &) override
        {
            return false;
        }
        bool requestMoveDialog(RS_CopyData &) override
        {
            return false;
        }
        bool requestRotateDialog(RS_RotateData &) override
        {
            return false;
        }
        bool requestScaleDialog(RS_ScaleData &) override
        {
            return false;
        }
        bool requestMirrorDialog(RS_MirrorData &) override
        {
            return false;
        }
        bool requestMoveRotateDialog(RS_MoveRotateData &) override
        {
            return false;
        }
        bool requestRotate2Dialog(RS_Rotate2Data &) override
        {
            return false;
        }
        bool requestModifyEntityDialog(RS_Entity *) override
        {
            return false;
        }
        bool requestMTextDialog(RS_MText *) override
        {
            return false;
        }
        bool requestTextDialog(RS_Text *) override
        {
            return false;
        }
        bool requestHatchDialog(RS_Hatch *) override
        {
            return false;
        }
